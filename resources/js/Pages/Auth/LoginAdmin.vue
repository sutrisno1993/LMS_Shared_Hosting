    ...
    <div class="relative z-10 w-full max-w-md px-4">
      ...
      <div class="glass-card p-10 shadow-2xl shadow-black/50 rounded-3xl" style="background: rgba(255,255,255,0.03); backdrop-filter: blur(20px); border: 1px solid rgba(255,255,255,0.05);">
        ...
        <div class="text-center mb-9">
          ...
          <h1 class="text-xl font-bold text-white">Login Admin</h1>
          <p class="text-xs text-slate-400 mt-1">Masuk ke Panel Kurikulum</p>
        </div>

        <form @submit.prevent="submit" class="space-y-4">
          <div>
            <label class="block text-[11px] font-semibold text-slate-500 uppercase tracking-wider mb-2">Email Admin</label>
            <div class="relative">
              ...
              <input
                ...
                type="email"
                required
                placeholder="admin@smk11maret.sch.id"
